...
import {changePassword} from '../../action/ProfileAction';
...
const mapStateToProps = (state) => ({
  changePasswordLoading: state.ProfilReducer.changePasswordLoading,
  changePasswordResult: state.ProfilReducer.changePasswordResult,
  changePasswordError: state.ProfilReducer.changePasswordError,
});
